<%-- 
    Document   : registerinfo_account_page
    Created on : 2 June 2025, 7:58:14 am
    Author     : HuyHoang
--%>
<%
...
<html>
    <head>
        ...
        <title>Hoàn tất hồ sơ của bạn</title>
        <link href="css/registerinfo_account_page.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div class="register-container">
            ...
            <form action="" method="post">
                ...
                <button type="submit" class="btn">Hoàn tất hồ sơ</button>
