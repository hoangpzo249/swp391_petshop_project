            ...
            <div class="admin-sidebar">
                ...
                <div class="sidebar-menu">
                    ...
                    <div class="menu-category">
                        ...
                        <a href="shipper_panel?action=Pending%20Shipper" class="sidebar-link">
                        ...
                        <a href="shipper_panel?action=Shipping" class="sidebar-link">
                        ...
                        <a href="shipper_panel?action=Delivered" class="sidebar-link">
            ...
            <div class="admin-content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-clipboard-list"></i> Đơn hàng gần đây
                        </h3>
                    </div>
                    <div class="card-body">
