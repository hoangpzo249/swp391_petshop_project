        ...
        <div class="card">
            <form action="adddiscount" method="POST">
                <div class="card-body">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="1000" id="minAmount" name="minAmount" class="form-control" value="${minAmount}">
                        </div>
                        <div class="form-group">
                            <label for="maxValue">Giảm tối đa (₫)</label>
                            <input type="number" step="1000" id="maxValue" name="maxValue" class="form-control" value="${maxValue}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" class="form-control">
                                ...
                                <option value="0" ${status == '0' ? 'selected' : ''}>Tạm tắt</option>
                            </select>
                        </div>
                ...
                <div class="card-footer">
                    <a href="displaydiscount" class="btn btn-outline">Hủy bỏ</a>
