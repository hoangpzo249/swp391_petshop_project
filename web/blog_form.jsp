...
<html>
    <head>
        ...
        <link href="css/blogForm.css?v=6" rel="stylesheet" type="text/css"/>
        ...
        <div class="form-container">
            <form id="blogForm" action="blog" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="form-group">
                        <label class="section-label">
                            <i class="fa-solid fa-eye"></i> Trạng thái hiển thị <span class="required">*</span>
                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <c:if test="${not empty featuredImage}">
                            ...
                            <img src="${featuredImage}" id="preview" alt="Ảnh đại diện bài viết">
                        </c:if>
                ...
                <div class="form-actions">
                    ...
                    <button type="button" onclick="setActionAndSubmit('save-draft')" class="btn-back">← Quay lại danh sách</button>
                </div>
            </form>
        </div>
