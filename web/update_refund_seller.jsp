...
<html>
    <head>
        ...
        <link href="css/seller_panel_page.css?v=9" rel="stylesheet" type="text/css"/>
                        ...
                        <div class="card-body">
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="refundReasonDescription" name="refundReasonDescription" class="form-control" rows="4" required style="height: 168px;">${refundReasonDescription != null ? refundReasonDescription : refund.refundReasonDescription }</textarea>
                                </div>
