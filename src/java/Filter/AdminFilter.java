 ...
 * @author HuyHoang
 */
@WebFilter(filterName = "AdminFilter", urlPatterns = {"/admin-panel"})
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (accAdmin == null || !"Admin".equals(accAdmin.getAccRole())) {
            res.sendRedirect("homepage");
            return;
        }

        if ("account".equals(action) && id != null && act != null) {
            if (act.equals("update-role") || act.equals("ban-acc") || act.equals("reset-pass")) {
                try {
                    ...
                    if (acc != null && "Admin".equals(acc.getAccRole())) {
